...
public class AccountTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(account);
		WithDraw(2100, account);
		System.out.println(account);
		WithDraw(12000, account);
		System.out.println(account);
		...
		System.out.println(account1);
		WithDraw(2000, account1);
		System.out.println(account1);
		WithDraw(12000, account1);
		System.out.println(account1);
		WithDraw(13100, account1);
		System.out.println(account1);
		WithDraw(1, account1);
		System.out.println(account1);
	 ...
	 private static void WithDraw(double amount,Account account) {
		 if(AccountType.SAVINGS.equals(account.getType())) {
